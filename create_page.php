...
<body>
    ...
    <div id="main-content">
        <div class="form-container">
            ...
            <form action="services/save_page.php" method="POST" enctype="multipart/form-data">
...
<div class="form-group">
    ...
    <select id="footer_id" name="footer_id" class="form-control">
        ...
        while ($footer = $footer_result->fetch_assoc()) {
            $selected = $footer['is_default'] ? 'selected' : '';
            echo "<option value='{$footer['id']}' {$selected}>{$footer['name']}</option>";
        }
        ?>
    </select>
</div>
